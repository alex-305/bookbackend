...
UPDATE users SET followercount = followercount+3 WHERE username='ted';
INSERT INTO user_follows_user(follower, followed) VALUES('allen','ted');
UPDATE users SET followercount = followercount+1 WHERE username='allen';
INSERT INTO user_follows_user(follower, followed) VALUES('ned','ted');
UPDATE users SET followercount = followercount+1 WHERE username='ned';
INSERT INTO user_follows_user(follower, followed) VALUES('john','ted');
UPDATE users SET followercount = followercount+1 WHERE username='john';
INSERT INTO user_follows_user(follower, followed) VALUES('fred','ted');
UPDATE users SET followercount = followercount+1 WHERE username='fred';
INSERT INTO user_follows_user(follower, followed) VALUES('jane','ted');
UPDATE users SET followercount = followercount+1 WHERE username='jane';
INSERT INTO user_follows_user(follower, followed) VALUES('peter','ted');
UPDATE users SET followercount = followercount+1 WHERE username='peter';
INSERT INTO user_follows_user(follower, followed) VALUES('miles','ted');
UPDATE users SET followercount = followercount+1 WHERE username='miles';
INSERT INTO user_follows_user(follower, followed) VALUES('james','ted');
UPDATE users SET followercount = followercount+1 WHERE username='james';